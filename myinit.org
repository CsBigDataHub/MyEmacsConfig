...
* Counsel/Ivy/Swiper
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq counsel-fzf-cmd "fd -HLia -t f --color never --exclude .git | /home/mypc/.fzf/bin/fzf -f \"%s\"")
  #+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;(setq load-path (cons (expand-file-name "/usr/local/share/emacs/site-lisp/mu4e")
  ;;                      load-path))
  ;;(require 'mu4e)
  ;;(setq load-path (cons (expand-file-name "~/.emacs.d/custom-el-scripts/org-mime")
  ;;                      load-path))
  ;;(require 'org-mime)
