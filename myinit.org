...
* Counsel/Ivy/Swiper
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (load-if-exists "/home/linuxlite/.emacs.d/custom-el-scripts/init-ivy-rich.el")
...
* Pyhton
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package virtualenvwrapper
      ...
      (setq venv-location "/home/linuxlite/.virtualenvs/")
      )
...
* Dump-Keys
  #+BEGIN_SRC emacs-lisp
  (load-if-exists "/home/linuxlite/.emacs.d/custom-el-scripts/dump-keys.el")
  #+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'load-path (expand-file-name "/home/linuxlite/.emacs.d/aweshell"))
  (require 'aweshell)
...
#+Begin_SRC emacs-lisp
  (setq custom-file "/home/linuxlite/.emacs.d/custom-el-scripts/custom-util-function.el")
...
#+BEGIN_SRC emacs-lisp
 (load-if-exists "/home/linuxlite/.emacs.d/custom-el-scripts/init-java.el")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;(setq org-plantuml-jar-path (expand-file-name "/home/linuxlite/GitRepos/plantuml.jar"))
  ;;(add-to-list
  ;; 'org-src-lang-modes '("plantuml" . plantuml))
  ;;(use-package plantuml-mode
  ;;  :ensure t
  ;;  :custom
  ;;  (plantuml-jar-path "/home/linuxlite/GitRepos/plantuml.jar")
  ;;  :mode "\\.uml\\'")
...
;;; Changed for Linux
  (use-package plantuml-mode
    ...
    :mode "\\.uml\\'"
    :init
    (setq plantuml-jar-path "/home/linuxlite/Downloads/plantuml.jar"))
  ...
  (use-package autoinsert
    ...
    (define-auto-insert
      ...
      '("Python Language"
        ...
        "email    : Chetan <chetan.koneru@optum.com>" \n
