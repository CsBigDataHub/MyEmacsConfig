...
#+BEGIN_SRC emacs-lisp
  ...
  (setq company-backends '((company-capf company-dabbrev company-dabbrev-code company-files)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq lsp-groovy-server-install-dir "~/.emacs.d/custom-el-scripts/lsp/groovy-language-server/build/libs/")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq lsp-xml-jar-file "~/GitRepos/org.eclipse.lsp4xml-0.3.0-uber.jar")
#+END_SRC
...
#+begin_src emacs-lisp
  (use-package esup
    ...
    :commands esup
    :config
    (setq esup-user-init-file (expand-file-name "~/.emacs.d/myinit.el"))
    )
#+end_src
